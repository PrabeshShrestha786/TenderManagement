	...
	<div class="container-fluid">
		...
		<div class="col-md-8">
			<div class="marquee"
				...
				<h4
					style="background-color: black; margin-top: -1.8px; margin-bottom: 1px; padding: 5px; text-align: center; color: white; font-weight: bold">
					&nbsp; <span id="pagetitle">Account Login</span>
				</h4>
				<!-- pagetitle id is given here -->
				<div class="marquee-content"
					style="align: center; padding-top: 100px; min-height: 750px; background-color: #9a6c44">
		...
		<tr>
			<td style="color:brown"></td>
					...
					<table class="tab hd blue" border="0px" cellpadding="10"
						cellspacing="10">
							...
							<td>
								<form action="LoginSrv" method="post">
									<br> Username: <input type="text" name="username"
										required="required" style="color: black; font-size: 19px;"><br />
									<br /> Password: <input type="password" name="password"
										required="required" style="color: black; font-size: 19px;"><br />
									<br /> <input type="submit" value="Login As Admin" name="user">
									&nbsp; &nbsp; &nbsp; &nbsp; <input type="submit"
										value="Login As Vendor" name="user"><br />
									<br />
								</form>
							</td>
