	...
	<div class="container-fluid">
		...
		<div class="col-md-8">
			<div class="marquee"
				...
				<h4
					style="background-color: black; margin-top: -1.8px; margin-bottom: 1px; padding: 5px; text-align: center; color: red; font-weight: bold">
					&nbsp; <span id="pagetitle">VENDOR ACCOUNT</span>
				</h4>
				<!-- pagetitle id is given here -->
				<div class="marquee-content"
					style="align: center; padding-top: 200px; min-height: 750px; background-color: #9a6c44">
					<h1>
						<center>Welcome to Tender Management system</center>
					</h1>
