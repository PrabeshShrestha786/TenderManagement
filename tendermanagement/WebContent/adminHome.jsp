...
<body>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:5px black hidden; background-color:white">
        <h4 style="background-color:black; margin-top:-1.8px; margin-bottom:1px;padding: 15px; text-align: center;color:green;font-weight:bold">
        &nbsp; <span id="pagetitle">Admin Account</span></h4><!-- pagetitle id is given here -->
        <div class="marquee-content" style="align:center; padding-top:200px;min-height:550px;background-color:#9a6c44">
     		<h1><center> Tender Management system</center></h1>
