...
<body>
  <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
        <h4 style="background-color:black; margin-top:1.8px; margin-bottom:1px;padding: 6px; text-align: center;color:white;font-weight:bold">
        &nbsp; <span id="pagetitle"></span></h4><!-- pagetitle id is given here -->
      <div class="marquee-content" style="padding:1px;padding-top:0px; font-weight: bold; font-size: 1.1em">
      <!-- height="900" -->   
      <marquee scrollamount=0 style="min-height:550px">
            ...
            <div class="slider">
              <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active"> <img src="images/cap2.jpg" style="width:100%; height: 550px"> </div>
                <div class="item"> <img src="images/cap1.jpeg" style="width:100%; height: 550px"> </div>
